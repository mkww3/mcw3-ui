...
export const Login = () => {
  ...
  return (
    <Section id="home" className='mx-auto my-auto text-center space-y-8 max-w-[1200px]'>
      ...
      <div className="max-w-[350px] mx-auto text-left flex flex-col space-y-4">
        ...
        <p className="text-sm">Don{'\''}t have an account? <a href="/register" className='font-semibold'>Register now.</a></p>
        <button onClick={async () => await login()} className="px-4 py-2 bg-green-900 text-white text-lg hover:bg-green-800">Submit</button>
      </div>
